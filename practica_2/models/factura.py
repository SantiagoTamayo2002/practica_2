class Factura:
    def __init__(self):
        ...
        self.__fecha = ""
        self.__monto = 0
        self.__tipoRUC = ""  # <- Tipo de RUC: educativo o profesional
        self.__RUC = ""      # <- este por etro lado es el numero que va a tener el RUC
...
#////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    __repr__ = __str__ # <- para que se pueda imprimir en consola