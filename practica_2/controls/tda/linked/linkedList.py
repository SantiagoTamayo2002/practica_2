...
#////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    def getNode(self, pos): # <- obtener un nodo como objeto, no como elemento de la lista
        if self.isEmpty:
            raise LinkedEmptyException("List empty")
        elif pos < 0 or pos >= self._length:
    ...
    def get(self, pos): # <- este es para obtener el elemento de la lista en una posicion definida.
        try:
    ...
    def binary_models(self, data, attribute, type: int = 1):
        array = self.toArray
        order = QuickSort()
        array = order.sort_models_ascendent(array, attribute)
        if self.isEmpty:
